...
namespace WindowsAzure.ServiceBus.Cqs
{
    ...
    public class AzureRequestReplyBus : IRequestReplyBus, IDisposable
    {
        ...
        /// <param name="replyQueueName">Queue which query results are sent back on. Name as you've configured it in the Azure management web. Dialogs must have been activated for this queue.</param>
        /// <remarks>
        ...
        /// queueName
        /// </exception>
        public AzureRequestReplyBus(string requestQueueConnectionString, string requestQueueName, string replyQueueConnectionString, string replyQueueName)
        {
